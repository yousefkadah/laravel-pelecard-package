...
class ResponseTest extends TestCase
{
    ...
    /** @test */
    public function it_detects_failed_response()
    {
    ...
    /** @test */
    public function it_extracts_transaction_id()
    {
    ...
    /** @test */
    public function it_extracts_error_message()
    {
    ...
    /** @test */
    public function it_throws_on_failed_response()
    {
